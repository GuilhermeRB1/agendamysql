...
CREATE USER 'agenda_contatos'@'localhost' IDENTIFIED WITH mysql_native_password BY 'agenda123'; 

    -- MySQL MariaDB:

CREATE USER 'agenda_contatos'@'localhost' IDENTIFIED BY 'agenda123'; 

-- Definindo permissões para o usuário da aplicação.

GRANT SELECT, INSERT, UPDATE, DELETE ON Agenda.* TO 'agenda_contatos'@'localhost';
